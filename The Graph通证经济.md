...
有一部分贡献到返现池中的请求费用被当作返现奖励分发，这里遵循Cobbs-Douglas产品功能设计。
...
*索引奖励收取* - Indexer收取的索引奖励比率  
*请求费用收取* - Indexer收取的请求费用比率  

Indexer根据代理的容量接受代理质押，这是他们自己质押量的数倍。Indexer与Delegator质押的比率将会有技术治理方案决定。
